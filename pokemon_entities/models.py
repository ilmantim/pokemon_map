...
class Pokemon(models.Model):
    ...
    previous_evolution = models.ForeignKey('self', related_name='next_evolutions', null=True, blank=True, on_delete=models.SET_NULL, verbose_name='Предыдущая эволюция')
